...
export class Cli {
            ...
            .prompt([
            {
                ...
                choices: this.vehicles.map((vehicle) => {
                    ...
                    if ('vin' in vehicle &&
                        ...
                        const carOrTruckOrMotorbike = vehicle;
    ...
    createMotorbike() {
        inquirer
            ...
            .then((answers) => {
            const motorbike = new Motorbike(Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [new Wheel()]);
